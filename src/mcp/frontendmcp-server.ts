...
export class FrontendMCPServer extends McpServer {
  ...
  constructor(serverInfo: Implementation & { frontendMCP?: FrontendMCPServerConfig }, options?: ServerOptions) {
    super(serverInfo, options);

    const frontendMCPConfig = serverInfo.frontendMCP === undefined ? {
      mcpServerUrl: "https://frontendmcp.com/mcp",
      websocketUrl: "wss://frontendmcp.com/mcp",
    } : serverInfo.frontendMCP;

    frontendMCPConfig.mcpServerUrl = frontendMCPConfig.mcpServerUrl ?? "https://frontendmcp.com/mcp";
    ...
    frontendMCPConfig.authorizationToken = frontendMCPConfig.authorizationToken ?? crypto.randomUUID();
